			...
			<Accordion allowMultiple margin={'0 auto'} style={{ width: '100%', maxWidth: '600px' }}>
				...
				<AccordionItem>
					<h2>
						<AccordionButton>
							<Box flex="1" textAlign="left">
								Does XFIGODSWAP take any fees?
							</Box>
							<AccordionIcon />
						</AccordionButton>
					</h2>
					<AccordionPanel pb={4}>
						XFIGODSWAP takes 0 fee on swaps.
						<br />
						<br /> You'll get the exact same price swapping through XFIGODSWAP as what you'd get swapping through the
						...
						of it is shared with XFIGODSWAP. We also integrate aggregators with no fee sharing the best price, and in
				...
				<AccordionItem>
					<h2>
						<AccordionButton>
							<Box flex="1" textAlign="left">
								Will I be eligible for aggregator airdrops if I swap through XFIGODSWAP?
							</Box>
							<AccordionIcon />
						</AccordionButton>
					</h2>
					<AccordionPanel pb={4}>
						...
						executed directly from their UI and a swap executed from XFIGODSWAP.
						<br />
						<br />
