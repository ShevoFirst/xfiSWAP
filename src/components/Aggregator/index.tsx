...
export function AggregatorContainer({ tokenlist }) {
	...
	return (
		<Wrapper>
			<Heading>XFIGODSWAP</Heading>

			<Text fontSize="1rem" fontWeight="500">
				This product created by Atilla. If you run into any issue please let us know in our{' '}
				<a style={{ textDecoration: 'underline' }} href="https://discord.gg/crossfi">
					discord server
				</a>
			</Text>
					...
					<div>
						<FormHeader>
							<Flex>
								<Box>Chain</Box>
								<Spacer />
								<Tooltip content="Redirect requests through the XFIGODSWAP Server to hide your IP address">
